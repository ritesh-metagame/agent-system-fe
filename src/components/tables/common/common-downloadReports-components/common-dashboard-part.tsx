...
export default function CommonDashboard({
    ...
    const [numberOfPlayerAssociatedWithAgent, setNumberOfPlayerAssociatedWithAgent] = useState(0);
        ...
        const fetchPlayers = async () => {
            try {
                ...
                if (response.data.code === 200) {
                    ...
                    toast.error(response.data.message ?? "Failed to fetch number of players associated with agent.");
                }
            } catch (error) {
        ...
        <div>
            ...
            <CardContent className="p-4  flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    <QRCodeSVG value={role === UserRole.GOLD ? `${referralLink}${userId}` : `${referralLink}`}
                               size={80}/>
            ...
            <div className="p-4 text-start">
                <p className="text-sm  font-bold">
                    Referral Link:{" "}
                    <a href={role === UserRole.GOLD ? `${referralLink}${userId}` : `${referralLink}`}
            ...
            <div className="container mb-10">
                ...
                <div className="mb-10">
                    ...
                    <div className="flex w-20 gap-2 items-center justify-between mb-4">
                        <div className={"bg-table-header text-white font-medium px-2 py-1 rounded"}>
                            PLAYERS
                        </div>
                        <div className={"border-2 text-black font-medium px-2 py-1 rounded"}>
