...
export const pendingSettlementColumnDefs: ColumnDef<PendingSettlement>[] = [
    ...
    {
        accessorKey: "transferableAmount",
        header: "Transferable Amount",
        cell: ({row}) => {
            const value = row.getValue("transferableAmount") as number | string;
            ...
            <div className="flex justify-between">
              ...
              <span>{formatCurrency(row.original.totalWithdrawals)}</span>
                            ...
                            <div className="flex justify-between font-semibold">
                                ...
                                <span>{formatCurrency(row.original.transferableAmount)}</span>
                            </div>
                            {/* <div className="flex justify-between font-semibold">
                <span>Bank Name:</span>
