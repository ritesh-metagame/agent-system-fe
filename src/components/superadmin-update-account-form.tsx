            ...
            try {
                ...
                if (data.code === "1014" && data.data?.user) {
                    ...
                    const formValues = {
                        ...
                        password: "",
                        eGamesCommission:
                            parseInt(commissionsByCategory.eGames) > 0
                                ? commissionsByCategory.eGames
                                : totalAssignedCommissionPercentageByCategory.eGames.toString(),
                        eGamesCommissionComputationPeriod:
                            commissionComputationPeriods.eGames as "BI_MONTHLY" | "WEEKLY",
                        sportsBettingCommission:
                            parseInt(commissionsByCategory.sportsBetting) > 0
                                ? commissionsByCategory.sportsBetting
                                : totalAssignedCommissionPercentageByCategory.sportsBetting.toString(),
                        sportsBettingCommissionComputationPeriod:
                            commissionComputationPeriods.sportsBetting as
                                | "BI_MONTHLY"
                                | "WEEKLY",
                        specialityGamesToteCommission:
                            parseInt(commissionsByCategory.specialityGamesTote) > 0
                                ? commissionsByCategory.specialityGamesTote
                                : totalAssignedCommissionPercentageByCategory.specialityGamesTote.toString(),
                        specialityGamesToteCommissionComputationPeriod:
                            commissionComputationPeriods.specialityGamesTote as
                                | "BI_MONTHLY"
                                | "WEEKLY",
                        specialityGamesRngCommission:
                            parseInt(commissionsByCategory.specialityGamesRng) > 0
                                ? commissionsByCategory.specialityGamesRng
                                : totalAssignedCommissionPercentageByCategory.specialityGamesRng.toString(),
            ...
            <CardContent className="px-3 sm:px-6">
                <Form {...form}>
                    ...
                    >
                        ...
                        <div className="col-span-1 lg:col-span-2">
                            <Accordion type="multiple" className="w-full">
                                ...
                                <AccordionItem value="egames">
                                    ...
                                    <AccordionContent
                                        className="flex flex-col md:flex-row items-start md:items-center gap-3 sm:gap-4 justify-center w-full">
                                        <FormField
                                            control={form.control}
                        ...
                        {/* Submit Button */}
                        <div
                            className="col-span-1 lg:col-span-2 flex flex-col sm:flex-row gap-3 sm:gap-4 sm:justify-end mt-4">
                            <Button
                                variant="secondary"
